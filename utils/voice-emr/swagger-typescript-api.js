...
export const generateCode = async (type, uri, username, password) => {
  const templatePath = {
    api: path.resolve(__dirname, "../../templates/voice-emr"),
    query: path.resolve(__dirname, `../../templates/voice-emr/queries`),
    mutation: path.resolve(__dirname, `../../templates/voice-emr/mutations`),
  };
